...
export const metadata: Metadata = pageMeta({
  ...
  description: 'Articles from the clinicians at RH Dental Care, Dhaka, on implants, orthodontics, root canal treatment and everyday dental care.',
  path: '/blog',
});


const categoryColors: Record<string, string> = {
  'Periodontology': '#9C7C38',
  'Oral & Maxillofacial Surgery': '#8A3B2A',
  'Conservative Dentistry & Endodontics': '#9C7C38',
  'Pediatric Dentistry': '#f97316',
  'Orthodontics': '#9C7C38',
  'Prosthodontics': '#CDAE51',
  'Aesthetic Dentistry': '#9C7C38',
  'Cross-Departmental': '#55684F',
};
      ...
      <div style={{
        ...
        <div style={{ maxWidth: '1200px', margin: '0 auto', position: 'relative', zIndex: 1 }}>
          <div style={{
            ...
            color: 'var(--rh-brass)', padding: '0.4rem 1rem',
          ...
          <h1 style={{
            ...
            <span style={{ color: 'var(--rh-brass)' }}>& Patient Guides</span>
          </h1>
          <p style={{ fontSize: '1.1rem', color: 'var(--rh-ink-soft)', maxWidth: '560px', lineHeight: 1.8 }}>
      ...
      <div style={{ maxWidth: '1200px', margin: '0 auto', padding: '3rem 2rem 5rem' }}>
        ...
        <div style={{
          ...
          {['All', ...blogCategories].map((cat) => {
            ...
            const color = cat === 'All' ? '#9C7C38' : (categoryColors[cat] ?? '#6E6B57');
            return (
              <Link
                key={cat}
        ...
        <div className="blog-grid">
          {filtered.map((post) => {
            const color = categoryColors[post.category] ?? '#6E6B57';
            return (
              <Link
                key={post.slug}
                href={`/blog/${post.slug}`}
                ...
                <div className="blog-card">
                  ...
                  <div style={{
                    ...
                    <span style={{
                      ...
                      fontSize: '0.78rem', color: '#8C8973', fontWeight: 600,
                    }}>
                      <Clock size={12} />
                      {post.readTime}
                    </span>
                  ...
                  <p style={{
                    fontSize: '0.85rem', color: '#6E6B57',
                    fontStyle: 'italic', marginBottom: '0.75rem', fontWeight: 500,
                  }}>
                    {post.subtitle}
                  </p>
                  <p style={{ fontSize: '0.875rem', color: '#6E6B57', lineHeight: 1.7, flex: 1 }}>
                    {post.summary}
                  </p>
                  <div style={{
        ...
        {filtered.length === 0 && (
          <div style={{ textAlign: 'center', padding: '5rem 0', color: '#8C8973' }}>
        ...
        <div style={{
          ...
          boxShadow: '0 30px 80px rgba(247, 245, 238, 0.32)',
        }}>
          <Star size={32} fill="#CDAE51" color="#CDAE51" style={{ marginBottom: '1rem' }} />
          <h2 style={{
            fontSize: 'clamp(1.5rem, 3vw, 2.25rem)',
            fontWeight: 600, color: 'var(--rh-ink)', marginBottom: '1rem',
            letterSpacing: '-0.03em',
          }}>
            Have more questions?
          </h2>
          <p style={{ color: 'var(--rh-ink-soft)', marginBottom: '2rem', fontSize: '1.05rem' }}>
          ...
          <Link href="/contact" style={{
            ...
            boxShadow: '0 12px 35px rgba(156,124,56,0.4)',
          }}>
            Book a Consultation
          </Link>
        </div>
