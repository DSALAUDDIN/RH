...
export const metadata: Metadata = pageMeta({
  ...
  description:
    'Articles from the clinicians at RH Dental Care, Dhaka, on implants, orthodontics, root canal treatment and everyday dental care.',
  path: '/blog',
});
...
export default async function BlogPage({
  ...
  return (
    <div style={{ background: '#f8fafc', minHeight: '100vh' }}>
      <JsonLd nodes={[breadcrumbs({ name: 'Articles', path: '/blog' })]} />
      {/* Hero */}
      <div
        style={{
      ...
      >
        ...
        <div style={{ maxWidth: '1200px', margin: '0 auto', position: 'relative', zIndex: 1 }}>
          ...
          >
            {blogPosts.length}+ detailed treatment guides covering every procedure we offer —
            written to help you make informed decisions about your oral health.
          </p>
        </div>
      </div>
