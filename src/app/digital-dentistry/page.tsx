      ...
      <section className="imp-hero dd-hero">
        ...
        <div className="imp-hero-content">
          ...
          <motion.div className="imp-hero-cta-row" initial={{ opacity:0, y:24 }} animate={{ opacity:1, y:0 }} transition={{ duration:0.8, delay:0.8 }}>
            <Link href="/contact" className="imp-btn-primary" style={{ background:'linear-gradient(135deg, #6366f1, #4f46e5)', boxShadow:'0 8px 32px rgba(99,102,241,0.4)' }}>
          ...
          <FadeIn delay={0.2}>
            <div className="imp-what-grid" style={{ background:'linear-gradient(135deg, #eef2ff, #e0e7ff)', border:'1px solid rgba(99,102,241,0.15)', borderRadius:'2rem', padding:'3rem', marginTop:'4rem', alignItems:'center' }}>
              <div>
                ...
                <p style={{ color:'#4338ca', lineHeight:1.8, margin:0 }}>We are continuously upgrading our technologies to deliver world-class dental services with greater accuracy and efficiency. Digital dentistry is the future — and we are already here.</p>
              </div>
        ...
        <div className="container">
          <FadeIn>
            <div className="imp-section-header">
              ...
              <h2 className="imp-title">Hear From Our <span className="imp-accent" style={{ background:'linear-gradient(135deg, #6366f1, #4f46e5)', WebkitBackgroundClip:'text', WebkitTextFillColor:'transparent', backgroundClip:'text' }}>Happy Patients</span></h2>
            ...
            <FadeIn>
              <div style={{ background: '#fff', borderRadius: '1.5rem', overflow: 'hidden', border: '1px solid rgba(99,102,241,0.1)', boxShadow: '0 12px 40px rgba(0,0,0,0.08)', position: 'relative' }}>
                ...
                <div style={{ padding: '1.5rem', textAlign: 'center' }}>
                  <div style={{ fontSize: '1.1rem', fontWeight: 800, color: '#1e293b', marginBottom: '0.25rem' }}>Our Happy Patient</div>
        ...
        <div className="container">
          ...
          <FadeIn delay={0.15}>
            <div className="imp-hero-cta-row" style={{ justifyContent:'center' }}>
              <Link href="/contact" className="imp-btn-primary" style={{ background:'linear-gradient(135deg, #6366f1, #4f46e5)', boxShadow:'0 8px 32px rgba(99,102,241,0.4)', padding:'1rem 2.5rem', fontSize:'1rem' }}>
