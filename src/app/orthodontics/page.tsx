...
const pageFaqs = [
  ...
  },
  {
    ...
    a: 'For mild to moderate cases, aligners deliver excellent results comparable to braces. For complex corrections involving severe crowding or bite issues, braces provide more control. Both are highly effective when used appropriately.',
  },
  {
    q: 'How long does orthodontic treatment take?',
    a: 'Treatment duration varies: simple aligner cases may take 6-12 months, while complex braces cases can take 18-24 months. Your personalized timeline is established during the consultation phase.',
  },
  {
    q: 'Is orthodontic treatment painful?',
    a: 'You may experience mild discomfort for 2-3 days after adjustments or new aligner trays. Modern brackets are smaller and smoother, and aligners are designed for maximum comfort.',
  },
  {
    q: 'Can adults get orthodontic treatment?',
    a: 'Absolutely. There is no age limit for orthodontics. Many of our patients are adults seeking improved alignment and bite correction, especially with the discreet option of clear aligners.',
  },
  {
    ...
    <div>
      ...
      <section className="imp-hero ortho-hero">
        <div className="imp-hero-bg">
          <Image
            src={heroImg}
            alt="Orthodontic Treatment at RH Dental Care"
            fill
            priority
            quality={90}
          />
        ...
        <div
          className="imp-hero-overlay"
          style={{
            background:
              'linear-gradient(180deg, rgba(2,6,23,0.6) 0%, rgba(2,6,23,0.35) 40%, rgba(2,6,23,0.9) 100%), radial-gradient(ellipse at 30% 20%, rgba(99,102,241,0.2) 0%, transparent 60%)',
          }}
        />
        <div className="imp-hero-content">
          ...
          >
            <Link href="/" className="ortho-breadcrumb">
              Home <ChevronRight size={12} /> <span>Specialties</span> <ChevronRight size={12} />{' '}
              <span className="ortho-breadcrumb-active">Orthodontics</span>
            </Link>
          </motion.div>
          <motion.div
            className="imp-badge ortho-badge"
          ...
          >
            Two advanced paths to the same confident smile. Controlled, gradual tooth movement
            guided by precision planning — tailored to your unique needs and lifestyle.
          </motion.p>
          <motion.div
            className="ortho-hero-stats"
          ...
          >
            ...
            <BranchCTA action="call" service="Orthodontics & Braces" className="imp-btn-glass">
        ...
        <div className="container">
          <FadeIn>
            <div className="ortho-philosophy-inner">
              <div className="ortho-philosophy-icon">
                <Smile size={28} />
              </div>
              <div>
                <div className="ortho-philosophy-title">A Balanced Perspective</div>
                <p className="ortho-philosophy-text">
                  Both braces and aligners are grounded in the same orthodontic principles:
                  controlled, gradual tooth movement guided by precision planning. The difference
                  lies in how that movement is delivered.{' '}
                  <strong>
                    Braces offer unmatched control and versatility. Aligners offer discretion and
          ...
          <FadeIn>
            <div className="imp-section-header">
              <span className="imp-label">
                <Award size={14} /> Investment in Your Future
              </span>
            ...
            <FadeIn delay={0.1}>
              <div className="ortho-option-card ortho-braces-card">
                <div className="ortho-card-header">
                  ...
                  <div>
                    ...
                    <div style={{ fontSize: '0.8rem', color: '#64748b', fontWeight: 600 }}>
                      Effective · Reliable · Transformative
                    </div>
                  </div>
                </div>
                ...
                <div className="ortho-advantages-list">
                  {[
                    {
                      t: 'Effective for all types of misalignment',
                      d: 'Ideal for simple to complex cases',
                    },
                    {
                    ...
                    <div
                      key={i}
                      className="ortho-advantage-item"
                      style={{ alignItems: 'flex-start' }}
                    >
                      <div
                        className="ortho-advantage-icon ortho-braces-adv-icon"
                ...
                <Link
                  href="/contact"
                  className="ortho-card-cta ortho-braces-cta"
                  style={{ width: '100%', justifyContent: 'center' }}
                >
                  Book Braces Consultation <ArrowUpRight size={16} />
                </Link>
              </div>
            </FadeIn>
              ...
              <div className="ortho-option-card ortho-aligner-card">
                ...
                <div className="ortho-advantages-list">
                  {[
                    ...
                    {
                      t: 'Advanced digital planning',
                      d: 'Precision planning for predictable results',
                    },
                    { t: 'Fewer dental visits', d: 'Convenient and time-saving' },
                    { t: 'Smooth & gentle movement', d: 'More comfort throughout the treatment' },
                    {
                      t: 'Ideal for adults & professionals',
                      d: 'Aesthetic solution for modern lifestyle',
                    },
                  ].map((item, i) => (
                    <div
                      key={i}
                    ...
                    >
                      <div
                        className="ortho-advantage-icon ortho-aligner-adv-icon"
                        style={{ marginTop: '0.2rem' }}
                      >
                        <CheckCircle2 size={14} />
                      </div>
                ...
                <Link
                  href="/contact"
                  className="ortho-card-cta ortho-aligner-cta"
                  style={{ width: '100%', justifyContent: 'center' }}
                >
                  Book Aligner Consultation <ArrowUpRight size={16} />
                </Link>
              </div>
            </FadeIn>
          </div>
          ...
          <div className="imp-what-grid">
            <FadeIn>
              <div className="imp-what-content">
                <span className="imp-label">
                  <Star size={14} /> Appreciating Both
                </span>
                <h2>
                  A Thoughtful <span style={{ color: '#6366f1' }}>Choice</span>
                </h2>
                <p>
                  Instead of choosing sides, it&apos;s important to recognize the unique strengths
                  of each approach. Some patients even benefit from a{' '}
                  <strong>hybrid approach</strong>, where both techniques are used strategically
                  during different phases.
                </p>
                <div className="imp-gallery-checks">
                  {[
                    'Braces excel in complexity and full control',
                    'Aligners excel in convenience and discretion',
                    'Both deliver excellent results when used appropriately',
                    'Hybrid approach combines best of both worlds',
                    'No one-size-fits-all — each case is unique',
                  ].map((t, i) => (
      ...
      <section className="imp-section imp-section-white">
        <div className="container">
          <FadeIn>
            <div className="imp-section-header">
              <span className="imp-label">
                <Sparkles size={14} /> The Future of Orthodontics
              </span>
              <h2 className="imp-title">
                How Does{' '}
                <span
              ...
              <p className="imp-subtitle">
                Move forward in life with a newer, better smile — make traditional braces a thing of
                the past.
              </p>
            </div>
          </FadeIn>
            ...
            <FadeIn delay={0.2}>
              <div className="ortho-invisalign-steps">
                ...
                {[
                  ...
                  >
                    <div
                      className="ortho-step-num"
                      style={{ background: step.bg, color: step.color }}
                    >
                      {step.num}
                    </div>
                    <div className="ortho-step-body">
                      <div className="ortho-step-title" style={{ color: step.color }}>
                        {step.title}
                      </div>
      ...
      <section className="imp-section imp-section-light">
        <div className="container">
          <FadeIn>
            <div className="imp-section-header">
              <span className="imp-label">
                <Layers size={14} /> The Braces Journey
              </span>
              <h2 className="imp-title">
                Stages of{' '}
                <span
              ...
              <p className="imp-subtitle">
                A step-by-step look at how modern braces gradually align your teeth for a perfect,
                healthy smile.
              </p>
            </div>
          </FadeIn>
          ...
          <div className="imp-what-grid ortho-invisalign-split" style={{ alignItems: 'center' }}>
            ...
            <FadeIn delay={0.2}>
              <div
                className="ortho-invisalign-img-frame"
                style={{ border: '2px solid rgba(99,102,241,0.1)' }}
              >
                <div
                  className="ortho-invisalign-img-glow"
                  style={{
      ...
      <section className="imp-section imp-section-white">
        <div className="container">
          <FadeIn>
            <div className="imp-section-header">
              <span className="imp-label">
                <ScanLine size={14} /> Our Clinical Approach
              </span>
              <h2 className="imp-title">
                Precision{' '}
                <span
              ...
              <p className="imp-subtitle">
                Every case begins with a comprehensive evaluation — then we recommend the most
                suitable option based on scientific accuracy and patient preference.
              </p>
            </div>
          </FadeIn>
          <motion.div
            className="ortho-why-grid"
            variants={stagger}
            initial="hidden"
            whileInView="show"
            ...
            {[
              {
                ...
                desc: 'Complete facial and dental analysis using high-resolution photography and software.',
                bg: '#e0f2fe',
                color: '#0ea5e9',
              },
              {
                ...
                desc: 'Precise digital impressions — no messy moulds, instant 3D models of your teeth.',
                bg: '#ede9fe',
                color: '#6366f1',
              },
              {
                icon: <Target size={24} />,
                title: 'Bite & Jaw Analysis',
                desc: 'Comprehensive assessment of occlusion, jaw alignment, and functional harmony.',
                bg: '#fef3c7',
                color: '#f59e0b',
              },
              {
                ...
                desc: 'Braces, aligners, or a combination — recommended based on your unique case.',
                bg: '#d1fae5',
                color: '#10b981',
              },
              {
                icon: <Eye size={24} />,
                title: 'Smile Preview',
                desc: 'See your predicted end-result before treatment begins with digital simulation.',
                bg: '#fce7f3',
                color: '#ec4899',
              },
              {
                ...
                desc: 'Regular check-ups with digital tracking to ensure your treatment stays on course.',
                bg: '#fee2e2',
                color: '#ef4444',
              },
            ].map((item, i) => (
              <motion.div key={i} className="ortho-why-card" variants={fadeUp}>
                <div className="ortho-why-icon" style={{ background: item.bg, color: item.color }}>
                  {item.icon}
                </div>
          ...
          <FadeIn>
            <div className="imp-section-header" style={{ color: '#fff' }}>
              ...
              <p className="imp-subtitle" style={{ color: 'rgba(203,213,225,0.8)' }}>
                Watch real orthodontic treatment at RH Dental Care — precision planning, modern
                technology, and stunning results.
              </p>
            </div>
          </FadeIn>
          <FadeIn delay={0.15}>
      ...
      <section className="imp-section imp-section-white">
        <div className="container">
          <FadeIn>
            <div className="imp-section-header">
              <span className="imp-label">
                <Heart size={14} /> The Outcome That Matters
              </span>
              <h2 className="imp-title">
                Regardless of Method, the{' '}
                <span
                  className="imp-accent"
                  style={{
                    background: 'linear-gradient(135deg, #6366f1, #4f46e5)',
          ...
          <motion.div
            ...
            style={{ gap: '1.5rem', maxWidth: 900, margin: '0 auto' }}
            variants={stagger}
            initial="hidden"
            whileInView="show"
            viewport={{ once: true }}
          >
            {[
              {
                icon: <Smile size={28} />,
                title: 'A Balanced, Natural Smile',
                desc: 'Perfectly aligned teeth that look and feel completely natural.',
                bg: '#ede9fe',
                color: '#6366f1',
              },
              {
                icon: <Zap size={28} />,
                title: 'Improved Function & Health',
                desc: 'Better chewing, easier cleaning, and long-term oral health benefits.',
                bg: '#e0f2fe',
                color: '#0ea5e9',
              },
              {
                ...
                desc: 'Retention protocols ensure your results last a lifetime.',
                bg: '#d1fae5',
                color: '#10b981',
              },
            ].map((item, i) => (
              ...
              >
                ...
                <p style={{ fontSize: '0.87rem', color: '#64748b', lineHeight: 1.75, margin: 0 }}>
                  {item.desc}
                </p>
              </motion.div>
            ))}
        ...
        <div className="container">
          <FadeIn>
            <div className="imp-section-header">
              ...
              <h2 className="imp-title">
                Orthodontics <span className="imp-accent">FAQs</span>
              </h2>
            </div>
          </FadeIn>
          ...
          <FadeIn>
            <div className="imp-cta-inner">
              ...
              <p className="imp-cta-sub">
                With the right expertise and technology, both braces and aligners can deliver
                exceptional, life-changing results. Book your consultation today.
              </p>
