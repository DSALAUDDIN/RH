...
const heroStats = [
  // REMOVED: '98% Success Rate', '12+ Years Exp.', '1000+ Implants Done' and
  // '5 Countries Trained'. A published implant success rate needs a case series
  // behind it, and the other three were unevidenced counts. Replaced with facts
  // that are checkable from this page.  docs/audit-report.md P2-2.
      ...
      <section className="imp-hero">
        ...
        <div className="imp-hero-content">
          ...
          <motion.div className="imp-hero-cta-row" initial={{ opacity: 0, y: 24 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.8, delay: 0.8 }}>
            <BranchCTA action="book" service="Dental Implants" className="imp-btn-primary">Book Consultation <ArrowUpRight size={18} /></BranchCTA>
            <BranchCTA action="call" service="Dental Implants" className="imp-btn-glass"><Phone size={16} /> Call Now</BranchCTA>
