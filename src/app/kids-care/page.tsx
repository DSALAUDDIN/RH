...
export const metadata: Metadata = pageMeta({
  ...
  description:
    'Paediatric dental care at RH Dental Care Banasree, Dhaka. Check-ups, fillings, extractions and treatment for children who are anxious about the chair.',
  path: '/kids-care',
});
...
export default function KidsCarePage() {
  return (
    <div className="kids-care-root" style={{ background: '#f8fafc', color: '#0f172a' }}>
      <JsonLd nodes={[breadcrumbs({ name: "Children's Dentistry", path: '/kids-care' })]} />
      ...
      >
        ...
        <div className="container" style={{ position: 'relative', zIndex: 2, maxWidth: '800px' }}>
          ...
          >
            We turn dental visits into fun adventures. Our paediatric team works at the
            child&rsquo;s pace, so a first visit is about getting comfortable in the chair — and
            that is what builds a lifetime of healthy dental habits.
          </p>
        ...
        <div className="container">
          <div style={{ textAlign: 'center', marginBottom: '4rem' }}>
            <h2 style={{ fontSize: '2.5rem', fontWeight: 800, color: '#0f172a' }}>
              Why Parents <span style={{ color: '#0ea5e9' }}>Trust Us</span>
            </h2>
            <p style={{ color: '#64748b', fontSize: '1.1rem', marginTop: '1rem' }}>
              We understand children, and we understand parents&rsquo; concerns.
            </p>
          </div>
          ...
          >
            {[
              {
                icon: <ShieldCheck size={32} color="#0ea5e9" />,
                title: 'Comfort-focused',
                desc: 'Topical then local anaesthetic, explained to the child first, at their pace.',
              },
              {
                icon: <Smile size={32} color="#f59e0b" />,
                title: 'Child-Friendly Environment',
                desc: 'A welcoming, colorful, and engaging clinic space that kids actually love visiting.',
              },
              {
                icon: <Stethoscope size={32} color="#10b981" />,
                title: 'Expert Pediatricians',
                desc: "BMDC certified specialists trained specifically in managing children's dental anxiety.",
              },
            ].map((feature, idx) => (
              <div
                key={idx}
      ...
      <section style={{ padding: '6rem 0', background: '#f1f5f9' }}>
        ...
        >
          ...
          <div>
            ...
            >
              From the first baby tooth to full teenage braces, we provide end-to-end dental care
              tailored for every stage of your child&rsquo;s development.
            </p>
