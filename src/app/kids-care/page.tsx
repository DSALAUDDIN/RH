      ...
      <section style={{ 
        ...
        <div className="container" style={{ position: 'relative', zIndex: 2, maxWidth: '800px' }}>
          ...
          <p style={{ 
            ...
            We turn dental visits into fun adventures. Our paediatric team works at the child's pace, so a first visit is about getting comfortable in the chair — and that is what builds a lifetime of healthy dental habits.
          </p>
      ...
      <section style={{ padding: '6rem 0', background: '#fff' }}>
        <div className="container">
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(300px, 1fr))', gap: '2rem' }}>
            {[
              { icon: <ShieldCheck size={32} color="#0ea5e9" />, title: 'Comfort-focused', desc: 'Topical then local anaesthetic, explained to the child first, at their pace.' },
