...
const faqs = [
  ...
  },
  {
    ...
    a: 'Yes — for most cases including vital teeth and early-stage infections, single-visit root canal is entirely safe and clinically superior. Only complex cases or active abscesses may require two visits.',
  },
  {
    q: 'How do I know if I need a root canal?',
    a: 'Common signs include severe toothache, prolonged sensitivity to hot/cold, darkening of the tooth, and swelling. However, some infected teeth cause no pain — regular check-ups matter.',
  },
  {
    ...
    <div>
      ...
      <section className="imp-hero rc-hero">
        <div className="imp-hero-bg">
          <Image
            src={heroImg}
            alt="Root Canal Treatment at RH Dental Care"
            fill
            priority
            quality={90}
          />
        ...
        <div className="imp-hero-content">
          ...
          >
            <Link href="/" className="rc-breadcrumb">
              Home <ChevronRight size={12} /> <span>Specialties</span> <ChevronRight size={12} />{' '}
              <span className="rc-breadcrumb-active">Root Canal</span>
            </Link>
          </motion.div>
          <motion.div
            className="imp-badge rc-badge"
          ...
          >
            <BranchCTA action="book" service="Root Canal Treatment" className="imp-btn-primary">
              Book Consultation <ArrowUpRight size={18} />
            </BranchCTA>
            <BranchCTA action="call" service="Root Canal Treatment" className="imp-btn-glass">
          ...
          <FadeIn>
            <div className="imp-section-header">
              <span className="imp-label">
                <Heart size={14} /> Tailored for Everyone
              </span>
              <h2 className="imp-title">
                Care Designed <span className="imp-accent">for You</span>
              </h2>
              <p className="imp-subtitle">
                Whether you are a local patient or traveling from abroad — our single-visit protocol
          ...
          <div className="rc-patient-grid">
            <FadeIn delay={0.1}>
              <div className="rc-patient-card rc-local-card">
                <div className="rc-patient-header">
                  <div className="rc-patient-icon rc-local-icon">
                    <User size={28} />
                  </div>
                  <div>
                ...
                <p className="rc-patient-desc">
                  We understand the demands of a busy lifestyle. Our single visit root canal ensures
                  you receive efficient, pain-relieving treatment in a single sitting—so you can
                  return to your routine without delay.
                </p>
                <div className="rc-patient-benefits">
                  {[
                    'One visit solution',
                    'Immediate relief from pain and infection',
                    'Fewer injections and reduced chair time',
                    'Safe, predictable, and modern technique',
                  ].map((b, i) => (
                    <div key={i} className="rc-patient-benefit">
                      <CheckCircle2 size={15} /> <span>{b}</span>
                    </div>
                  ))}
                </div>
                <Link href="/contact" className="rc-patient-cta rc-local-cta">
            ...
            <FadeIn delay={0.2}>
              <div className="rc-patient-card rc-intl-card">
                <div className="rc-patient-header">
                  <div className="rc-patient-icon rc-intl-icon">
                    <Globe size={28} />
                  </div>
                  <div>
                ...
                <p className="rc-patient-desc">
                  For patients traveling abroad, every day matters. Our single visit protocol is
                  designed to deliver premium-quality treatment within a limited stay, without
                  compromising clinical excellence.
                </p>
                <div className="rc-patient-benefits">
                  {[
                ...
                <Link href="/contact" className="rc-patient-cta rc-intl-cta">
          ...
          <div className="imp-what-grid">
            <FadeIn>
              <div className="imp-what-content">
                <span className="imp-label">
                  <Award size={14} /> Uncompromised Quality
                </span>
                <h2>
      ...
      <section className="imp-section rc-tech-section">
        <div className="container">
          <FadeIn>
            <div className="imp-section-header">
              <span className="imp-label">
                <Zap size={14} /> Technology-Driven Endodontics
              </span>
              <h2 className="imp-title">
                Precision at <span className="imp-accent">Every Level</span>
              </h2>
              <p className="imp-subtitle">
                Technology is not an addition — it is the foundation. Every root canal is performed
                using a comprehensive digital and microscopic workflow.
              </p>
            </div>
          </FadeIn>
          ...
          <FadeIn>
            <div className="rc-tech-category">
              <div className="rc-tech-cat-label">
                <ScanLine size={16} /> Advanced Diagnostic &amp; Imaging
              </div>
            </div>
          </FadeIn>
          <motion.div
            className="rc-tech-grid rc-tech-grid-2"
            variants={stagger}
            initial="hidden"
            whileInView="show"
          ...
          >
            <motion.div
              className="rc-tech-card"
              variants={fadeUp}
              style={{ '--card-color': '#0ea5e9', '--card-bg': '#e0f2fe' } as React.CSSProperties}
            >
              <div className="rc-tech-icon" style={{ background: '#e0f2fe', color: '#0ea5e9' }}>
                <ScanLine size={26} />
              </div>
              <div className="rc-tech-title">CBCT (3D Imaging)</div>
              <p className="rc-tech-desc">
                Detailed three-dimensional view of tooth anatomy, infections, and surrounding bone —
                ensuring accurate diagnosis and precise treatment planning.
              </p>
            ...
            <motion.div
              className="rc-tech-card"
              variants={fadeUp}
              style={{ '--card-color': '#6366f1', '--card-bg': '#ede9fe' } as React.CSSProperties}
            >
              <div className="rc-tech-icon" style={{ background: '#ede9fe', color: '#6366f1' }}>
                <Activity size={26} />
              </div>
              <div className="rc-tech-title">RVG (Digital X-Ray)</div>
              <p className="rc-tech-desc">
                Instant, high-resolution imaging with minimal radiation exposure, allowing real-time
                evaluation and monitoring throughout the procedure.
              </p>
          ...
          <FadeIn>
            <div className="rc-tech-category" style={{ marginTop: '3rem' }}>
              <div className="rc-tech-cat-label">
                <Target size={16} /> Enhanced Clinical Precision
              </div>
            </div>
          </FadeIn>
          <motion.div
          ...
          >
            <motion.div
              className="rc-tech-card"
              variants={fadeUp}
              style={{ '--card-color': '#f59e0b', '--card-bg': '#fef3c7' } as React.CSSProperties}
            >
              <div className="rc-tech-icon" style={{ background: '#fef3c7', color: '#f59e0b' }}>
                <Microscope size={26} />
              </div>
              <div className="rc-tech-title">Dental Operating Microscope</div>
              <p className="rc-tech-desc">
                High magnification and illumination enable detection of complex or hidden canals,
                cracks, and anatomical variations — significantly improving treatment accuracy.
              </p>
            ...
            <motion.div
              className="rc-tech-card"
              variants={fadeUp}
              style={{ '--card-color': '#10b981', '--card-bg': '#d1fae5' } as React.CSSProperties}
            >
              <div className="rc-tech-icon" style={{ background: '#d1fae5', color: '#10b981' }}>
                <Target size={26} />
              </div>
              <div className="rc-tech-title">Apex Locator</div>
              <p className="rc-tech-desc">
                Electronic working length measurement ensures precise canal preparation and reduces
          ...
          <FadeIn>
            <div className="rc-tech-category" style={{ marginTop: '3rem' }}>
              <div className="rc-tech-cat-label">
                <Zap size={16} /> Modern Endodontic Systems
              </div>
            </div>
          </FadeIn>
          <motion.div
          ...
          >
            <motion.div
              className="rc-tech-card"
              variants={fadeUp}
              style={{ '--card-color': '#ef4444', '--card-bg': '#fee2e2' } as React.CSSProperties}
            >
              <div className="rc-tech-icon" style={{ background: '#fee2e2', color: '#ef4444' }}>
                <Zap size={26} />
              </div>
              <div className="rc-tech-title">Rotary Endodontics</div>
              <p className="rc-tech-desc">
                Advanced flexible instruments allow efficient, smooth, and minimally invasive canal
                shaping.
              </p>
            ...
            <motion.div
              className="rc-tech-card"
              variants={fadeUp}
              style={{ '--card-color': '#8b5cf6', '--card-bg': '#ede9fe' } as React.CSSProperties}
            >
              <div className="rc-tech-icon" style={{ background: '#ede9fe', color: '#8b5cf6' }}>
                <Layers size={26} />
              </div>
              <div className="rc-tech-title">Advanced Irrigation &amp; Disinfection</div>
              <p className="rc-tech-desc">
                Enhanced protocols ensure deep cleaning of even the most complex canal systems,
                eliminating bacteria effectively.
              </p>
        ...
        <div className="container">
          <div className="imp-what-grid">
            <FadeIn>
              <div className="imp-what-content">
                <span className="imp-label">
                  <ShieldCheck size={14} /> State-of-the-Art Care
                </span>
                <h2>
                  Premium Clinical <span style={{ color: '#059669' }}>Environment</span>
                </h2>
                <p>
                  Experience root canal treatment in a modern, fully-equipped clinical setting
                  designed for maximum precision, sterility, and patient comfort.
                </p>
                <div className="imp-gallery-checks">
                  {[
                    'Advanced Sterilization Protocols',
                    'Ergonomic Patient Seating',
                    'Integrated Digital Workflow',
                    'Calm & Relaxing Atmosphere',
                    'Dedicated Micro-Endodontics Setup',
                  ].map((t, i) => (
                    <div key={i} className="imp-gallery-check">
                      <CheckCircle2 size={16} />
                      {t}
            ...
            <FadeIn delay={0.15}>
              <div className="imp-what-img">
                <Image
                  src={otImg}
                  alt="Root Canal Clinical Facility"
                  fill
                  sizes="(max-width:1024px) 100vw, 50vw"
                  style={{ objectFit: 'cover' }}
                />
        ...
        <div className="container">
          <FadeIn>
            <div className="imp-section-header" style={{ color: '#fff' }}>
              ...
              >
                <Play size={14} /> Watch the Procedure
              </span>
              ...
              <p className="imp-subtitle" style={{ color: 'rgba(203,213,225,0.8)' }}>
                Watch a real single-visit root canal treatment performed at RH Dental Care with
                microscope guidance and digital workflow.
              </p>
            </div>
          </FadeIn>
          <FadeIn delay={0.15}>
          ...
          <FadeIn delay={0.25}>
            <div className="imp-video-badges">
              {[
                ...
                <div
                  key={i}
                  className="imp-video-badge-item"
            ...
            <FadeIn>
              <div className="imp-what-img">
                <Image
                  ...
                  style={{ objectFit: 'cover' }}
                />
                <div className="rc-img-badge">
                  <Microscope size={14} /> Microscope-Guided
                </div>
              </div>
            </FadeIn>
            <FadeIn delay={0.15}>
              <div className="imp-what-content">
                <span className="imp-label">
                  <ShieldCheck size={14} /> Long-Term Success
                </span>
                <h2>
                  Save Your Natural <span style={{ color: '#059669' }}>Tooth for Life</span>
                </h2>
                <p>
                  Following root canal treatment, a dental crown is strongly recommended to restore
                  structural integrity and function. With proper care, a treated tooth can last many
                  ...
                  {[
                    {
                      ...
                      desc: 'Ensures a durable, hermetic seal to prevent reinfection permanently.',
                      bg: 'linear-gradient(135deg, #0ea5e9, #0284c7)',
                    },
                    {
                      icon: <Award size={18} />,
                      title: 'Post-Endodontic Crown',
                      desc: 'Restores strength, function, and long-term durability of the treated tooth.',
                      bg: 'linear-gradient(135deg, #6366f1, #4f46e5)',
                    },
                    {
                      icon: <Activity size={18} />,
                      title: 'Digital Follow-Up',
                      desc: 'Remote monitoring ensures smooth healing — especially for international patients.',
                    ...
                    >
                      <div className="imp-anatomy-icon" style={{ background: item.bg }}>
                        {item.icon}
                      </div>
                      <div>
                ...
                <div className="rc-candidate-box">
                  <div className="rc-candidate-title">
                    <Target size={16} /> Is Single Visit Right for You?
                  </div>
                  <p className="rc-candidate-desc">
                    Ideal for vital teeth, early-stage infections, and patients without severe
                    swelling or active abscess. For more complex conditions, a multi-visit approach
                    may be recommended for optimal healing.
                  </p>
                </div>
              </div>
            </FadeIn>
      ...
      <section className="imp-section imp-section-light">
        <div className="container">
          <FadeIn>
            <div className="imp-section-header">
              <span className="imp-label">
                <Stethoscope size={14} /> Common Questions
              </span>
              <h2 className="imp-title">
                Root Canal <span className="imp-accent">FAQs</span>
              </h2>
            </div>
          </FadeIn>
          ...
          <FadeIn>
            <div className="imp-cta-inner">
              ...
              <p className="imp-cta-sub">
                At RH Dental Care, we combine advanced technology, clinical precision, and
                patient-focused care to deliver dentistry that meets international standards.
              </p>
