...
const otFeatures = [
  { icon: <ShieldCheck size={20}/>, title: 'Hospital-Grade Sterilization', desc: 'Strict infection control protocols maintained at every step of every procedure.', color: '#ef4444', bg: '#fee2e2' },
  { icon: <Stethoscope size={20}/>, title: 'Pre-Operative Assessment', desc: 'Complete medical evaluation before every surgical procedure for maximum safety.', color: '#6366f1', bg: '#ede9fe' },
  { icon: <Layers size={20}/>,     title: 'Intraoperative Monitoring', desc: 'Continuous vital sign monitoring by experienced anesthesiology team throughout.', color: '#0ea5e9', bg: '#e0f2fe' },
  { icon: <AlignJustify size={20}/>, title: 'Post-Operative Care', desc: 'Detailed recovery guidelines, follow-ups, and support until full healing is achieved.', color: '#10b981', bg: '#d1fae5' },
];
...
export default function DentalSurgeryPage() {
  return (
    <div>
        ...
        <div className="imp-hero-content">
          <motion.div initial={{ opacity:0, y:-14 }} animate={{ opacity:1, y:0 }} transition={{ duration:0.6 }}>
            <Link href="/" style={{ color:'rgba(255,255,255,0.5)', textDecoration:'none', fontSize:'0.85rem', fontWeight:600, display:'inline-flex', alignItems:'center', gap:'0.4rem', marginBottom:'1rem' }}>
              Home <ChevronRight size={12}/> <span style={{ color:'rgba(255,255,255,0.8)' }}>Specialties</span> <ChevronRight size={12}/> <span style={{ color:'#fca5a5' }}>Dental Surgery</span>
            </Link>
          </motion.div>
          ...
          <motion.h1 className="imp-hero-title" initial={{ opacity:0, y:40 }} animate={{ opacity:1, y:0 }}
          ...
          <motion.div className="imp-hero-cta-row" initial={{ opacity:0, y:24 }} animate={{ opacity:1, y:0 }} transition={{ duration:0.8, delay:0.8 }}>
            <Link href="/contact" className="imp-btn-primary" style={{ background:'linear-gradient(135deg, #ef4444, #dc2626)', boxShadow:'0 8px 32px rgba(239,68,68,0.4)' }}>
          ...
          <div className="imp-what-grid">
            ...
            <FadeIn delay={0.15}>
              <div className="imp-what-content">
                ...
                <h2>Comprehensive Surgical <span style={{ color:'#ef4444' }}>Excellence</span></h2>
                ...
                <div className="imp-anatomy-list" style={{ marginTop:'1.75rem' }}>
                  {[
                    { n:'01', t:'Simple to complex oral surgical cases', c:'linear-gradient(135deg, #ef4444, #dc2626)' },
                    { n:'02', t:'Hospital-grade OT & sterilization protocols', c:'linear-gradient(135deg, #6366f1, #4f46e5)' },
                    { n:'03', t:'GA management with certified hospital partners', c:'linear-gradient(135deg, #0ea5e9, #0284c7)' },
                  ].map((item, i) => (
        ...
        <div className="container">
          <FadeIn>
            <div className="imp-section-header">
              ...
              <h2 className="imp-title">Our Dental <span className="imp-accent" style={{ background:'linear-gradient(135deg, #ef4444, #dc2626)', WebkitBackgroundClip:'text', WebkitTextFillColor:'transparent', backgroundClip:'text' }}>Surgical Services</span></h2>
                  ...
                  <div className="imp-what-grid" style={{ alignItems:'start', gap:'2rem' }}>
                    <div>
                      <div style={{ display:'flex', alignItems:'center', gap:'1rem', marginBottom:'1rem' }}>
                        ...
                        <h3 style={{ fontSize:'1.2rem', fontWeight:900, color:'#0f172a', margin:0, letterSpacing:'-0.01em' }}>{svc.title}</h3>
                      </div>
                      <p style={{ color:'#475569', lineHeight:1.75, margin:0, fontSize:'0.92rem' }}>{svc.desc}</p>
                    </div>
          ...
          <div className="imp-what-grid" style={{ alignItems:'center' }}>
            <FadeIn>
              <div className="imp-what-content">
                ...
                <h2>Experienced OT & <span style={{ color:'#ef4444' }}>Surgical Team</span></h2>
        ...
        <div className="container">
          <FadeIn>
            <div className="imp-section-header">
              ...
              <h2 className="imp-title">Why Choose <span className="imp-accent" style={{ background:'linear-gradient(135deg, #ef4444, #dc2626)', WebkitBackgroundClip:'text', WebkitTextFillColor:'transparent', backgroundClip:'text' }}>RH Dental Care?</span></h2>
            ...
            {whyUs.map((t, i) => (
              <FadeIn key={i} delay={i * 0.07}>
                <div style={{ background:'#fff', border:'1px solid rgba(239,68,68,0.08)', borderRadius:'1.25rem', padding:'1.5rem', textAlign:'center', boxShadow:'0 4px 20px rgba(0,0,0,0.02)', transition:'all 0.3s ease' }}
                  ...
                  <div style={{ width:44, height:44, borderRadius:12, background:'#fee2e2', display:'flex', alignItems:'center', justifyContent:'center', margin:'0 auto 1rem', color:'#ef4444' }}>
                    <CheckCircle2 size={20}/>
                  </div>
                  <p style={{ margin:0, fontSize:'0.85rem', fontWeight:700, color:'#1e293b', lineHeight:1.4 }}>{t}</p>
                </div>
              </FadeIn>
            ))}
          </div>
      ...
      {/* ═══════════════ CTA ═══════════════ */}
      <section className="imp-video-section" style={{ background:'linear-gradient(135deg, #020617 0%, #1c0a0a 50%, #020617 100%)' }}>
        ...
        <div className="container">
          ...
          <FadeIn delay={0.15}>
            <div className="imp-hero-cta-row" style={{ justifyContent:'center' }}>
              <Link href="/contact" className="imp-btn-primary" style={{ background:'linear-gradient(135deg, #ef4444, #dc2626)', boxShadow:'0 8px 32px rgba(239,68,68,0.4)', padding:'1rem 2.5rem', fontSize:'1rem' }}>
                Book Surgical Consultation <ArrowUpRight size={18}/>
              </Link>
              <a href="tel:+8801775227902" className="imp-btn-glass"><Phone size={16}/> Call Now</a>
              <a href="https://wa.me/8801775227902" target="_blank" rel="noopener noreferrer" className="imp-btn-glass" style={{ color:'#25D366' }}><MessageCircle size={16}/> WhatsApp</a>
