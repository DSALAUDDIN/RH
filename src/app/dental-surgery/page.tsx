...
const services = [
  {
    ...
    bg: '#fee2e2',
    features: [
      'Complete safety monitoring throughout',
      'Multiple procedures in one session',
      'Collaboration with certified hospitals',
      'Expert anesthesia team on standby',
    ],
  },
  {
    ...
    bg: '#ede9fe',
    features: [
      'Jaw and facial fracture stabilization',
      'Functional rehabilitation planning',
      'Aesthetic care post-surgery',
  ...
  },
  {
    ...
    features: [
      ...
      'Benign tumor & cyst management',
      'Selected oral cancer procedures',
...
const otFeatures = [
  {
    ...
    desc: 'Strict infection control protocols maintained at every step of every procedure.',
    color: '#ef4444',
    bg: '#fee2e2',
  },
  {
    ...
    desc: 'Complete medical evaluation before every surgical procedure for maximum safety.',
    color: '#6366f1',
    bg: '#ede9fe',
  },
  {
    ...
    desc: 'Continuous vital sign monitoring by experienced anesthesiology team throughout.',
    color: '#0ea5e9',
    bg: '#e0f2fe',
  },
  {
    ...
    desc: 'Detailed recovery guidelines, follow-ups, and support until full healing is achieved.',
    color: '#10b981',
    bg: '#d1fae5',
  },
];
    ...
    <div>
      ...
      <section className="imp-hero ds-hero">
        <div className="imp-hero-bg">
          <Image
            src={heroImg}
            alt="Advanced Dental Surgery at RH Dental Care"
            fill
            priority
            quality={90}
          />
        ...
        <div className="imp-hero-content">
          ...
          >
            ...
            >
              ...
              <ChevronRight size={12} /> <span style={{ color: '#fca5a5' }}>Dental Surgery</span>
            </Link>
          </motion.div>

          <motion.div
            className="imp-badge ds-badge"
          ...
          >
            Comprehensive oral and maxillofacial surgical solutions — from wisdom tooth removal to
            complex reconstructive procedures — delivered with precision, safety, and compassionate
            care.
          </motion.p>
          ...
          >
            ...
            <BranchCTA action="call" service="Dental & Oral Surgery" className="imp-btn-glass">
          ...
          <div className="imp-what-grid">
            <FadeIn>
              <div className="imp-what-img">
                <Image
                  src={surgeonImg}
                  alt="Dental surgeon with surgical loupes"
                  fill
            ...
            <FadeIn delay={0.15}>
              <div className="imp-what-content">
                <span className="imp-label ds-label">
                  <Award size={14} /> Clinical Excellence
                </span>
                <h2>
                  Comprehensive Surgical <span style={{ color: '#ef4444' }}>Excellence</span>
                </h2>
                <p>
                  At RH Dental Care, we provide advanced and comprehensive dental surgical solutions
                  with a strong focus on patient safety, precision, comfort, and long-term treatment
                  success.
                </p>
                <p>
                  Our experienced surgical team, modern OT support, and{' '}
                  <strong>multidisciplinary treatment approach</strong> allow us to manage simple to
                  highly complex oral and maxillofacial surgical cases with confidence.
                </p>
                <p>
                  We are committed to delivering{' '}
                  <strong>safe, ethical, and evidence-based surgical care</strong> using modern
                  techniques, advanced instruments, and proper surgical protocols.
                </p>
                ...
                <div className="imp-anatomy-list" style={{ marginTop: '1.75rem' }}>
                  {[
                    {
                      n: '01',
                      t: 'Simple to complex oral surgical cases',
                      c: 'linear-gradient(135deg, #ef4444, #dc2626)',
                    },
                    {
                      n: '02',
                      t: 'Hospital-grade OT & sterilization protocols',
                      c: 'linear-gradient(135deg, #6366f1, #4f46e5)',
                    },
                    {
                      n: '03',
                      t: 'GA management with certified hospital partners',
        ...
        <div className="container">
          <FadeIn>
            <div className="imp-section-header">
              <span className="imp-label ds-label">
                <Layers size={14} /> Surgical Services
              </span>
              ...
              <p className="imp-subtitle">
                A full spectrum of oral and maxillofacial surgical care — managed by experienced
                specialists with advanced technology and strict safety protocols.
              </p>
            </div>
          </FadeIn>
                  ...
                  <div className="imp-what-grid" style={{ alignItems: 'start', gap: '2rem' }}>
                    ...
                    <div className="imp-gallery-checks">
                      {svc.features.map((f, j) => (
                        <div key={j} className="imp-gallery-check">
                          <CheckCircle2 size={15} style={{ color: svc.color }} />
                          {f}
                        </div>
                      ))}
                    </div>
        ...
        <div className="container">
          <div className="imp-what-grid" style={{ alignItems: 'center' }}>
            <FadeIn>
              <div className="imp-what-content">
                <span className="imp-label ds-label">
                  <Building2 size={14} /> Operation Theater
                </span>
                <h2>
                  Experienced OT & <span style={{ color: '#ef4444' }}>Surgical Team</span>
                </h2>
                <p>
                  Our highly experienced Operation Theater (OT) team follows strict sterilization
                  and infection control protocols to maintain the highest standards of patient
                  safety and surgical excellence.
                </p>
                <p>
                  From <strong>pre-operative assessment</strong> to{' '}
                  <strong>post-operative care</strong>, every procedure is carefully monitored and
                  professionally managed by our dedicated surgical team.
                </p>
                ...
                >
                  {otFeatures.map((f, i) => (
                    <motion.div
                      ...
                      style={{ borderTop: `3px solid ${f.color}`, padding: '1.25rem' }}
                      variants={fadeUp}
                    >
                      <div
                        className="imp-type-icon"
                      ...
                      <div
                        className="imp-type-title"
                        style={{ fontSize: '0.88rem', marginBottom: '0.3rem' }}
                      >
                        {f.title}
                      </div>
                      <p className="imp-type-desc" style={{ fontSize: '0.77rem' }}>
                        {f.desc}
                      </p>
                    </motion.div>
                  ))}
            ...
            <FadeIn delay={0.15}>
              <div
                ...
                style={{ height: '420px', borderRadius: '2rem', overflow: 'hidden' }}
              >
                <Image
                  src={gumImg}
                  alt="RH Dental Care surgical team and OT"
                  fill
                  sizes="50vw"
                  style={{ objectFit: 'cover' }}
                />
        ...
        <div className="container">
          <FadeIn>
            <div className="imp-section-header">
              ...
              <p className="imp-subtitle">
                We are dedicated to providing advanced dental surgical care with compassion,
                precision, and modern technology to ensure the best possible treatment outcomes.
              </p>
            </div>
          </FadeIn>
      ...
      <section
        ...
        style={{ background: 'linear-gradient(135deg, #020617 0%, #1c0a0a 50%, #020617 100%)' }}
      >
        <div
        ...
        <div
          ...
          style={{ background: 'radial-gradient(circle, rgba(220,38,38,0.07), transparent 70%)' }}
        />
        <div className="container">
          <FadeIn>
            <div className="imp-section-header" style={{ color: '#fff' }}>
              ...
              <p className="imp-subtitle" style={{ color: 'rgba(203,213,225,0.8)' }}>
                At RH Dental Care, every surgical procedure is performed with the highest level of
                precision, care, and patient safety. Book a consultation today and let our expert
                team guide you toward the best surgical solution.
              </p>
            </div>
          </FadeIn>
          <FadeIn delay={0.15}>
