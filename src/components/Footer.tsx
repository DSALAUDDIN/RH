    ...
    <footer className="footer">
      <div className="container">
        <div className="footer-grid">
          ...
          <div className="footer-brand">
            ...
            <div className="social-links">
              <a
                href="https://www.facebook.com/share/18YJPadCbX/?mibextid=wwXIfr"
                target="_blank"
          ...
          <div className="footer-links">
            ...
            <ul style={{ marginBottom: '2rem' }}>
              ...
              <li>
                <Link href="/banani">Banani Branch</Link>
              </li>
              <li>
                <Link href="/banasree">Banasree Flagship Hospital</Link>
              </li>
              <li>
            ...
            <ul>
              <li>
                <Link href="/implants">Dental Implants</Link>
              </li>
              <li>
                <Link href="/orthodontics">Braces & Aligners</Link>
              </li>
              <li>
                <Link href="/root-canal">Root Canal</Link>
              </li>
              <li>
                <Link href="/digital-dentistry">Digital Dentistry</Link>
              </li>
            </ul>
          </div>
          ...
          <div className="location-card">
            ...
            <div className="location-content">
              <h4>
                <MapPin size={18} /> Banasree Branch (Flagship)
              </h4>
              <ul>
                <li>
                ...
                <li>
                  ...
                  <a
                    href={`tel:${BRANCHES.banasree.phone}`}
                    style={{ fontWeight: 600, color: '#e2e8f0' }}
                  >
                    {BRANCHES.banasree.phoneDisplay}
                  </a>
                </li>
                <li>
          ...
          <div className="location-card">
            ...
            <div className="location-content">
              <h4>
                <MapPin size={18} /> Banani Branch (Private Suite)
              </h4>
              <ul>
                <li>
                  <MapPin size={16} className="contact-icon" style={{ marginTop: '2px' }} />
                  <span>
                    Level 7 (B&B Empire)
                    <br />
                    Plot 116, Road 11, Banani
                  </span>
                </li>
                <li>
                  <Phone size={16} className="contact-icon" />
                  <a
                    href={`tel:${BRANCHES.banani.phone}`}
                    style={{ fontWeight: 600, color: '#e2e8f0' }}
                  >
                    {BRANCHES.banani.phoneDisplay}
                  </a>
                </li>
                <li>
                  <Mail size={16} className="contact-icon" />
                  <span>
                    <a href="mailto:drhasan0712@gmail.com">drhasan0712@gmail.com</a>
                  </span>
                </li>
              </ul>
              <div style={{ marginTop: '10px' }}>
        ...
        <div className="footer-payments">
          <div className="footer-payments-inner">
            ...
            <div className="payment-icons">
              ...
              <div
                className="pay-badge"
                style={{ backgroundColor: '#fff', border: '1px solid #e2e8f0', gap: '4px' }}
              >
        ...
        <div className="footer-bottom">
          <p>
            © {new Date().getFullYear()} RH Dental Care & Implant Center — Banasree, Dhaka. All
            Rights Reserved.
            <span style={{ margin: '0 8px', opacity: 0.5 }}>|</span>
            Powered by{' '}
            <a
              href="https://www.zitra.org"
              target="_blank"
              rel="noopener noreferrer"
